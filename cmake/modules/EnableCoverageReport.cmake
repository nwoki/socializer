...
FUNCTION(ENABLE_COVERAGE_REPORT)
    ...
    IF(CMAKE_COMPILER_IS_GNUCXX AND TOOL_FOUND AND "${COVERAGE_BUILD_TYPE}" MATCHES "coverage")
        ...
        SET(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS_DEBUG} " -fprofile-arcs -ftest-coverage" PARENT_SCOPE)
        SET(CMAKE_C_FLAGS ${CMAKE_C_FLAGS_DEBUG} " -fprofile-arcs -ftest-coverage" PARENT_SCOPE)
        ...
        IF(GCOVR_FOUND)
            ...
            FILE(APPEND ${COVERAGE_XML_COMMAND_FILE}
                 "EXECUTE_PROCESS(COMMAND \"${GCOVR_EXECUTABLE}\" -x -e ".*moc_." -r \"${CMAKE_SOURCE_DIR}\" OUTPUT_FILE \"${COVERAGE_XML_FILE}\" WORKING_DIRECTORY \"${CMAKE_BINARY_DIR}\")\n")
